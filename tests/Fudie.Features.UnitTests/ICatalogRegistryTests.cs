...
public class ICatalogRegistryTests
{
    ...
    [Fact]
    public void ICatalogRegistry_ShouldDeclareExactlyFiveMethods()
    {
    ...
    public void ICatalogRegistry_ShouldDeclareRegisterMethod()
    {
        ...
        method.GetParameters()[0].Name.Should().Be("className");
        ...
        method.GetParameters()[2].Name.Should().Be("aggregate");
    ...
    public void ICatalogRegistry_ShouldDeclareFindEndpointMethod()
    {
        ...
        method.GetParameters()[0].Name.Should().Be("displayName");
    }
    ...
    public void ICatalogRegistry_ShouldDeclareFindClassNameMethod()
    {
        ...
        method.GetParameters().Should().HaveCount(1);
        method.GetParameters()[0].Name.Should().Be("endpoint");
