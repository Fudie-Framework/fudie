...
public class IAggregateDescriptionTests
{
    ...
    [Fact]
    public void IAggregateDescription_ShouldHaveExactlyFiveProperties()
    {
        var type = typeof(IAggregateDescription);
    ...
    [Fact]
    public void IAggregateDescription_ShouldDeclareNoMethods()
    {
        var methods = typeof(IAggregateDescription)
